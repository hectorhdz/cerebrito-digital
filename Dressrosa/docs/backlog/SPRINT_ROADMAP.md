...
| Sprint 3 | Users and organization | User CRUD; role assignment; employee-manager mapping | Admin/HR user management works; relationships query correctly | In Progress | BL-006 completed; BL-007/BL-008/BL-009 pending |
