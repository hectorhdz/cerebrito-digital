...
| Sprint 1 | Project bootstrap | FastAPI app skeleton; config/dependency management; SQLAlchemy base models; Alembic init; health endpoint; base layout page | App boots locally; initial migration applies | In Progress | BL-001 completed in this branch |
