...
| Sprint 3 | Users and organization | User CRUD; role assignment; employee-manager mapping | Admin/HR user management works; relationships query correctly | Completed | BL-006, BL-007, BL-008, and BL-009 completed and ready for merge |
| Sprint 4 | Leave taxonomy and requests | Leave types/subtypes CRUD; leave request submit/list; request state transitions | Employee can submit requests; status updates correctly | In Progress | BL-011, BL-012, and BL-013 completed; depends on Sprint 3 |
