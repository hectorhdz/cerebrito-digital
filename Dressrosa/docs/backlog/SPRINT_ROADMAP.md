...
| Sprint 4 | Leave taxonomy and requests | Leave types/subtypes CRUD; leave request submit/list; request state transitions | Employee can submit requests; status updates correctly | In Progress | BL-011 and BL-012 completed; depends on Sprint 3 |
