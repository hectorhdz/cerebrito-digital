...
| Sprint 2 | Auth and roles | Login/logout; password hashing; session auth; API token/JWT auth; role guards | Protected endpoints enforce roles; auth tests pass | In Progress | BL-004, BL-005, and BL-010 completed in this branch |
